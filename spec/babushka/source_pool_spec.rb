...
describe SourcePool, '#template_for' do
  ...
  it "should look up the correct templates without namespacing" do
    Base.sources.template_for('meta 1').should == @meta1
    Base.sources.template_for('meta 3').should == @meta3
  end
  it "should find the dep when the namespace is correct" do
